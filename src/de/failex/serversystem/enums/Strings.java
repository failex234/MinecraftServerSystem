...
public enum Strings {
    ...
    GAMEMODE_SET_TO_PLAYER(PREFIX.getString() + "Gamemode of %s changed to " + ChatColor.RED + "%s"),
    ...
    SUDO_RUNNING(PREFIX.getString() + "Forcing %s to run %s..."),
    SUDO_PLAYER_NOT_ONLINE(PREFIX.getString() + "This player doesn't seem to be online!"),
    SYSTEM_INFO(PREFIX.getString() + "v.%s by %s"),
    SYSTEM_INFO_COMP_DATE(PREFIX.getString() + "Compiled on %s"),
    TIME_USAGE(PREFIX.getString() + "Usage: /time <set|add|rem> <day/1200>"),
    TIME_SET_TO(PREFIX.getString() + "Time in world %s set to %s"),
    TIME_ADDED_TO(PREFIX.getString() + "Added %s ticks to time in world %s"),
    TIME_REMOVED(PREFIX.getString() + "Removed %s ticks from time in world %s"),
    ...
    TP_TELEPORTING_A_TO_B(PREFIX.getString() + "Teleporting %a to %s..."),
    ...
    SKULL_SENT_BY(PREFIX.getString() + "%s sent you a skull from %s!"),
    SKULL_SENT_TO(PREFIX.getString() + "The skull of %s was sent to %s!"),
    ...
    MSG_NO_ARGS(PREFIX.getString() + "You need a player to send a message to"),
    MSG_NO_MSG(PREFIX.getString() + "You need to enter a message to send to the player"),
    MSG_NO_SELF_MSG(PREFIX.getString() + "You can't send a message to yourself"),
    MSG_WRONG_RECV(PREFIX.getString() + "That player does not exist!"),
    REPLY_MISSING_MSG(PREFIX.getString() + "You need a message to reply with"),
    REPLY_NO_SENT(PREFIX.getString() + "There is no message you can reply to"),
    REPLY_SENDER_OFFLINE(PREFIX.getString() + "The sender of the last message is offline"),
    ;
